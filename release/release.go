...
type VersionConfig struct {
	...
	// `git describe --tags`. When false and Version is empty, DeriveVersion
	// falls through to DevFallback (or errors).
	Describe bool
...
// gitDescribe runs `git describe --tags [--match <pat>]` and returns the
// trimmed output.
