...
All notable changes to the **`github.com/sparkwing-dev/sparks-core/step`** module
are documented here. Format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/);
versions follow [Semantic Versioning](https://semver.org/spec/v2.0.0.html).

Tagging convention: `step/vMAJOR.MINOR.PATCH` (per Go module
...
### Added
- Initial release. Shared step-banner and error-wrapped shell helpers used across the other modules.
